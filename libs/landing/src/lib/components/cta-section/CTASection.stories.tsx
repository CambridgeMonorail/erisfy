...
export const Default: Story = {
  ...
  args: {
    ...
    description: 'Try our live demo to see how effortlessly you can set up and scale your React project with Erisfy.',
...
export const WithDifferentProps: Story = {
  ...
  args: {
    ...
    description: 'Erisfy is built by developers, for developers. Contribute, discuss, and shape the future of the project.',
