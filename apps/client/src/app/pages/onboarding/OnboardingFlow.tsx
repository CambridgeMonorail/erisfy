...
const OnboardingFlow: FC = () => {
  ...
  const welcomeContent = {
    ...
    description:
      'Making smarter investment decisions has never been easier. Erisfy helps you find, analyze, and track stocks that fit your investment goals—faster and more efficiently. Whether you’re a seasoned investor or just getting started, our AI-powered filters and insights help you maximize your potential.',
    bulletPoints: [
  ...
  const investmentStyles = [
    {
      ...
      description:
        'For those seeking high-growth stocks with strong future potential.',
      criteria: [
    ...
    },
    {
      ...
      description:
        'For those who prefer to invest in undervalued stocks with strong fundamentals.',
      criteria: [
    ...
    },
    {
      ...
      description:
        'For those looking for steady income through high-dividend-paying stocks.',
      criteria: [
        'High dividend yield',
        'Stable earnings',
        'Strong payout ratio',
    ...
    },
    {
      ...
      description:
        'For those who trade based on stock price trends and technical indicators.',
      criteria: [
        'High RSI',
    ...
    },
    {
      ...
      description:
        'For those who want a diversified approach combining value, growth, and income.',
      criteria: [
      ...
      <Card className="w-full mx-auto">
        ...
        <CardContent>
                  ...
                  <CarouselContent>
                    <CarouselItem className="basis-1/2">
                      <div className="flex flex-col items-center">
                        ...
                        <h3 className="text-xl font-semibold mb-2">
                          Smarter Stock Filtering
                        </h3>
                        <p className="text-center">
                          Find the right stocks—faster. Tired of sifting through
                          endless tickers? Erisfy’s advanced filtering system
                          helps you discover stocks that match your strategy in
                          seconds. Whether you're a growth investor, a value
                          seeker, or a momentum trader, our powerful filters
                          make stock discovery effortless.
                        </p>
                      </div>
                    </CarouselItem>
                    <CarouselItem className="basis-1/2">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-center">
                          Let AI do the heavy lifting. Stop guessing—Erisfy’s
                          AI-driven analytics scan the market in real time,
                          delivering trend analysis, risk signals, and strategic
                          insights tailored to your investment style. Stay ahead
                          of market movements with cutting-edge AI
                          recommendations.
                        </p>
                      </div>
                    </CarouselItem>
                    <CarouselItem className="basis-1/2">
                      <div className="flex flex-col items-center">
                        ...
                        <h3 className="text-xl font-semibold mb-2">
                          A Personalized Investing Experience
                        </h3>
                        <p className="text-center">
                          Your strategy, your way. Investing isn’t
                          one-size-fits-all. Erisfy adapts to your goals,
                          whether you’re optimizing for long-term growth,
                          dividends, or short-term trading opportunities. Save
                          custom filters, track watchlists, and receive tailored
                          updates—all in a beautifully intuitive interface.
                        </p>
                      </div>
                    </CarouselItem>
                    <CarouselItem className="basis-1/2">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-center">
                          Stay updated with real-time market data. Erisfy
                          provides you with the latest market information,
                          ensuring you make informed decisions based on the most
                    ...
                    <CarouselItem className="basis-1/2">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-center">
                          Get a complete view of your stocks. Erisfy’s
                          comprehensive stock analysis tools provide you with
                          detailed insights into each stock’s performance,
                          helping you make well-informed investment decisions.
                        </p>
                      </div>
                    </CarouselItem>
                  </CarouselContent>
          ...
          {step === 5 && (
            <div>
              <h2 className="text-2xl font-bold mb-4">
                Redirecting to Stock Screener Results
              </h2>
